                    ...
                    if (apiStatus.Equals(200))
                    {
                        if (respond is CreatePlaylistObject result)
                        {
                            ...
                            try
                            {
                                ...
                                dataPlaylistFragment?.PlaylistList.Insert(0, result.Data);
                                dataPlaylistFragment?.NotifyItemInserted(dataPlaylistFragment.PlaylistList.IndexOf(dataPlaylistFragment.PlaylistList.FirstOrDefault()));
