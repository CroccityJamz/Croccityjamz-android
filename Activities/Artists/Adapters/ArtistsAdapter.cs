...
namespace DeepSound.Activities.Artists.Adapters
{
    public class ArtistsAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        private readonly bool ChangeHeight;

        public ArtistsAdapter(Activity context , bool changeHeight = true)
        {
            try
            {
        ...
        public override long GetItemId(int position)
        {
            try
            {
                return ArtistsList[position].Id;
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
