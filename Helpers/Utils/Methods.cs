        ...
        public static void DisplayReportResult(Activity activityContext, dynamic respond)
        {
            if (AppSettings.SetApisReportMode)
            {
                ...
                if (respond is ErrorObject error)
                {
                    ...
                    if (errorText.Contains("You ain't logged in") || errorText.Contains("Invalid access token"))
                    {
        ...
        public class AudioRecorderAndPlayer
        {
            ...
            public AudioRecorderAndPlayer()
            {
                try
                {
                    ...
                    SoundFileFullPath = new File(Path.FolderDcimSound + "/" + SoundFile);

                    var dir = Path.FolderDcimSound;
                ...
                bool saveOnPersonalFolder = true, bool saveOnGallaryFolder = false)
            {
                ...
                if (saveOnGallaryFolder)
                {
                    ...
                    if (System.IO.File.Exists(pathOfFile))
                    {
                        ...
                        MediaScannerConnection.ScanFile(Application.Context, new string[] { pathOfFile }, null, null);
